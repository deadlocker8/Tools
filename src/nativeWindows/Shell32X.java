...
public interface Shell32X extends Shell32
{
	...
	public static class SHELLEXECUTEINFO extends Structure
	{
		 ...
		 * HINSTANCE hInstApp; LPVOID lpIDList; LPCTSTR lpClass; HKEY hkeyClass;
		 * DWORD dwHotKey; union { HANDLE hIcon; HANDLE hMonitor; }
		...
		{
			return Arrays.asList(new String[] { "cbSize", "fMask", "hwnd", "lpVerb", "lpFile", "lpParameters", "lpDirectory", "nShow", "hInstApp", "lpIDList", "lpClass", "hKeyClass", "dwHotKey",
					"hMonitor", "hProcess", });
		}
	}
}